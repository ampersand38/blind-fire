...
def main():
    ...
    print("""
  ######################################
  # BLF Development Environment Setup #
  ######################################

  This script will create your BLF dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your BLF project folder:
    [Arma 3 installation directory]\\{} => BLF project folder
    P:\\{}                              => BLF project folder
